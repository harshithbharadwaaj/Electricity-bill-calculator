...
public class Project extends JFrame implements ActionListener
    {
        String accttype,meter;
        Project(String accttype,String meter)
        {
            ...
            ImageIcon icon9=new ImageIcon(ClassLoader.getSystemResource("icons/icon8.png"));
            ...
            ImageIcon icon10=new ImageIcon(ClassLoader.getSystemResource("icons/icon8.png"));
